        ...
        $(document).ready(function() {
            $("#pinned, #unpinned").sortable({
                ...
                update: function(event, ui) {
                    var orderPinned = $("#pinned").sortable('toArray', { attribute: 'data-id' });
                    var orderUnpinned = $("#unpinned").sortable('toArray', { attribute: 'data-id' });
                    
                    $.ajax({
                        url: "controller/update_notes_order.php",
                        type: "POST",
                        data: { pinned: orderPinned, unpinned: orderUnpinned },
